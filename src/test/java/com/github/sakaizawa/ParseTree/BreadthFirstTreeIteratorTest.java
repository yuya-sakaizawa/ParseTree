...
public class BreadthFirstTreeIteratorTest {
    ...
    public void testHasNext() throws Exception {
        ...
        BreadthFirstTreeIterator parseTreeIterator = new BreadthFirstTreeIterator(parseTree);
        ...
        parseTreeIterator = new BreadthFirstTreeIterator(parseTree);
        assertTrue(parseTreeIterator.hasNext());
        parseTreeIterator.next();
        assertTrue(parseTreeIterator.hasNext());
        parseTreeIterator.next();
    ...
    public void testNext() throws Exception {
        ...
        parseTreeIterator = new BreadthFirstTreeIterator(parseTree.getChild(0));
        assertEquals("POS1-1", parseTreeIterator.next().getLabel());
        assertEquals("POS2-1", parseTreeIterator.next().getLabel());
        assertEquals("POS2-2", parseTreeIterator.next().getLabel());
    }
